...
function load_video_post_style() {
    wp_enqueue_style('scpic-admin-style', get_template_directory_uri().'/scopic-admin-functions/css/scopic-admin-style.css');
    
    wp_enqueue_style('video-uploader-style', get_template_directory_uri().'/scopic-admin-functions/video-uploader/video-uploader-style.css');
}
...
function load_video_post_script() {
    ...
    wp_enqueue_script('video-uploader-script', get_template_directory_uri().'/scopic-admin-functions/video-uploader/video-uploader-functions.js');
}
