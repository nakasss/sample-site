...
if ( ! function_exists( 'scopic_admin_setup' ) ) :
/**
...
add_action( 'after_setup_theme', 'scopic_admin_setup' );
 ...
 */
require_once locate_template('scopic-admin/scopic-admin.php');